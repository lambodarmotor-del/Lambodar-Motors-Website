    ...
    card.innerHTML = `
      ...
      <div class="review-author" style="margin-top: 20px; display: flex; align-items: center; gap: 12px; text-align: left; width: 100%;">
        ...
        <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
          <span style="font-weight: 700; font-size: 15px; color: var(--text-white);">${sanitizeHTML(review.name)}</span>
          <span class="review-badge" style="display: inline-block; font-size: 11px; color: #4ade80; background: rgba(74, 222, 128, 0.08); border: 1px solid rgba(74, 222, 128, 0.2); border-radius: 4px; padding: 2px 8px; font-weight: 600;">${sanitizeHTML(review.badge)}</span>
        </div>
      </div>
    `;
